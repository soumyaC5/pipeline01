...
```
This command will create your personal repository under `/Repos/<username>/v1`.
...
- To trigger the release pipeline, get the current version from the `v1/__init__.py` file and tag the current code version:
```
